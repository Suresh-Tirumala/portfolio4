            ...
            <div className="w-full h-full flex flex-row items-center justify-between m-auto px-[0px] md:px-[10px]">
                ...
                <div className="hidden w-3/6 lg:w-1/3 h-full md:flex flex-row items-center justify-between md:mx-auto lg:pr-12">
                    <div className="flex items-center justify-between w-full h-auto border border-[#7042f861] bg-[#0300145e] mr-[15px] px-[20px] py-[10px] rounded-full text-gray-200">
                        <a href="#about" className="cursor-pointer hover:text-[#ba9cff] transition-colors">
                            About
                        </a>
                        <a href="#skills" className="cursor-pointer hover:text-[#ba9cff] transition-colors">
                            Skills
                        </a>
                        <a href="#experience" className="cursor-pointer hover:text-[#ba9cff] transition-colors">
                            Experience
                        </a>
                        <a href="#projects" className="cursor-pointer hover:text-[#ba9cff] transition-colors">
                            Projects
                        </a>
                        <a href="#contact" className="cursor-pointer hover:text-[#ba9cff] transition-colors">
                            Contact
                        </a>
                    </div>
                </div>
